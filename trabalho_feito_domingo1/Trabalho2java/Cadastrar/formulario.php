...
<html lang="pt-br">
  ...
  <body>
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <a class="navbar-brand" href="../index.html">Cadastror</a>
      ...
      <form action="cadastro.php" method="POST">
            <div class="row">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nome de Usuario:" name="usuario" > 
                </div>
            </div>
                </div>
        <div class="row">
